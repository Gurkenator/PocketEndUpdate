package net.gurken.impactful_end.item.custom;
...
public class ModSmithingTemplateItem extends Item {
    ...
    private static final String DESCRIPTION_ID = Util.makeDescriptionId("item", new ResourceLocation(Impactful_End.MOD_ID,"smithing_template"));
    private static final Component INGREDIENTS_TITLE = Component.translatable(Util.makeDescriptionId("item", new ResourceLocation(Impactful_End.MOD_ID,"smithing_template.ingredients"))).withStyle(TITLE_FORMAT);
    private static final Component APPLIES_TO_TITLE = Component.translatable(Util.makeDescriptionId("item", new ResourceLocation(Impactful_End.MOD_ID,"smithing_template.applies_to"))).withStyle(TITLE_FORMAT);
    private static final Component ENDERITE_UPGRADE = Component.translatable(Util.makeDescriptionId("upgrade", new ResourceLocation(Impactful_End.MOD_ID,"enderite_upgrade"))).withStyle(TITLE_FORMAT);
    private static final Component ENDERITE_UPGRADE_APPLIES_TO = Component.translatable(Util.makeDescriptionId("item", new ResourceLocation(Impactful_End.MOD_ID,"smithing_template.enderite_upgrade.applies_to"))).withStyle(DESCRIPTION_FORMAT);
    private static final Component ENDERITE_UPGRADE_INGREDIENTS = Component.translatable(Util.makeDescriptionId("item", new ResourceLocation(Impactful_End.MOD_ID,"smithing_template.enderite_upgrade.ingredients"))).withStyle(DESCRIPTION_FORMAT);
    private static final Component ENDERITE_UPGRADE_BASE_SLOT_DESCRIPTION = Component.translatable(Util.makeDescriptionId("item", new ResourceLocation(Impactful_End.MOD_ID,"smithing_template.enderite_upgrade.base_slot_description")));
    private static final Component ENDERITE_UPGRADE_ADDITIONS_SLOT_DESCRIPTION = Component.translatable(Util.makeDescriptionId("item", new ResourceLocation(Impactful_End.MOD_ID,"smithing_template.enderite_upgrade.additions_slot_description")));
    private static final ResourceLocation EMPTY_SLOT_BOW = new ResourceLocation(Impactful_End.MOD_ID,"item/empty_slot_bow");
    private static final ResourceLocation EMPTY_SLOT_CROSSBOW = new ResourceLocation(Impactful_End.MOD_ID,"item/empty_slot_crossbow");
